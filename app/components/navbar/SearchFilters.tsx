        ...
        >
            <div className="hidden lg:block">
                <div className="flex flex-row items-center justify-between">
                    ...
                    <div className="cursor-pointer h-[48px] lg:h-[64px] px-8 flex flex-col justify-center rounded-full hover:bg-gray-100">
                        <p className="text-xs font-semibold">Spaces</p>
                        <p className="text-sm">Add spaces</p>
                    </div>

                    <div className="cursor-pointer h-[48px] lg:h-[64px] px-8 flex flex-col justify-center rounded-full hover:bg-gray-100">
                        <p className="text-xs font-semibold">Vehicle type</p>
                        <p className="text-sm">Add vehicle type</p>
                    </div>
                </div>
            </div>

            <div className="p-2">
                <div className="cursor-pointer p-2 lg:p-4 bg-blue-500 hover:bg-blue-1000 transition rounded-full text-white">
                    <svg 
                        viewBox="0 0 32 32" 
